...
public enum PresetEventType {
	...
	ELECTRICITY_PRICE_LOW( EventTypeConstants.EVENT_TYPE_ELECTRICITY_PRICE_LOW, List.of()),
	ELECTRICITY_PRICE_HIGH( EventTypeConstants.EVENT_TYPE_ELECTRICITY_PRICE_HIGH, List.of());
