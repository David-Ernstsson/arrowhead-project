...
public class CarConsumerMain implements ApplicationRunner {
    ...
    public void createCarServiceOrchestrationAndConsumption() {
		...
		if (orchestrationResponse == null) {
			...
			final List<CarRequestDTO> carsToCreate = List.of(new CarRequestDTO("bertie", "grey"), new CarRequestDTO("mazda", "blue"), new CarRequestDTO("opel", "blue"), new CarRequestDTO("nissan", "gray"));
